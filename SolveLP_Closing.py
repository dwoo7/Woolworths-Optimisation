...
def solveLP(Weekday, closing, closing_store):
    ...
    elif Weekday == True and closing == True:
        route_name_data = pd.read_csv("Store_Data_Nonzero_Closing.csv")
        route_matrix = np.loadtxt(open("Route_Matrix_Weekday_Closing.csv"), delimiter=",", skiprows=0)
        route_time_vector = np.loadtxt(open("Route_Times_Weekday_Closing.csv"), delimiter=",", skiprows=0)
        route_pallets_vector = np.loadtxt(open("Route_Pallets_Weekday_Closing.csv"), delimiter=",", skiprows=0)
    
    elif Weekday == False and closing == True:
        route_name_data = pd.read_csv("Store_Data_Some_zero_Closing.csv")
        route_matrix = np.loadtxt(open("Route_Matrix_Weekend_Closing.csv"), delimiter=",", skiprows=0)
        route_time_vector = np.loadtxt(open("Route_Times_Weekend_Closing.csv"), delimiter=",", skiprows=0)
        route_pallets_vector = np.loadtxt(open("Route_Pallets_Weekend_Closing.csv"), delimiter=",", skiprows=0)
    else:
